...
class CustomerInformation extends JFrame implements ActionListener {
    JButton cancel;
    ...
    public void table1() {
        ...
        heading.setBounds(370, 15, 300, 30);
        ...
        try {
            Conn c = new Conn();
            String query = "SELECT name, address, contact, room, deposit, checkin FROM customer ";
            ...
            String Names[]={"Name", "Address","Contact","Room No","Deposit","Check In Time"};
...
public class CustomerInfo {
    public static void main(String[] args) {
        CustomerInformation r = new CustomerInformation();
